"use client";
/*
 * Formulaire public d'une instance, accessible à la racine via /<slug>.
 * Charge la campagne par son slug, puis rend le formulaire scopé.
 * (Les routes statiques — /admin, /api, /c, etc. — ont priorité sur ce segment
 * dynamique ; les slugs réservés sont interdits à la création.)
 */
